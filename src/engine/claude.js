...
// prompt caching, no service tier selection, no sampling tuning, no explicit
// thinking configuration and no streaming is used.
...
// The Messages API requires `max_tokens`. This is a protocol ceiling on the
// length of one answer, not a summary target length and not a setting: no
// reader has the information to choose it, and the prompt's own "no target
// length" instruction is what actually governs how long a summary is.
